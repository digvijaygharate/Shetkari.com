...
public class apply_for_farmer extends HttpServlet 
{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
        ...
        try
        {
            ...
            PreparedStatement ps=con.prepareStatement("insert into applied_farmer(femail, farmerid, date2, time2) values(?,?,?,?)");
