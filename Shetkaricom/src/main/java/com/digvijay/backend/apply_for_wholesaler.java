...
public class apply_for_wholesaler extends HttpServlet 
{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
        ...
        try
        {
            ...
            PreparedStatement ps=con.prepareStatement("insert into applied_ws(wemail, wsid, date1, time1) values(?,?,?,?)");
            ...
            if(i>0)
            {
                ...
                RequestDispatcher rd2=req.getRequestDispatcher("navbar_wholesaler_desc.jsp?wid="+wid);
