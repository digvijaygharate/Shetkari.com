...
public class user_wholesaler_mess extends HttpServlet 
{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
	{
	       ...
	       // String status2=req.getParameter("status");
	        ...
	        try
	        {
	            ...
	            PreparedStatement ps1=con.prepareStatement("update applied_ws_user set wemail=?,date1=?,time1=?, status1=?, mess=? where wsid=?");
	            ...
	            else
	            {
	                ...
	                RequestDispatcher rd2=req.getRequestDispatcher("user_wholesaler_applied.jsp");
