...
try{
	...
	if(z==1)
	{
		s.executeUpdate("update cart set ctotal='"+cart_total+"',cquantity='"+quantity+"' where cproduct_id='"+product_id+"' and cemail='"+email+"' and caddress is NULL ");
		response.sendRedirect("user_farmer_products.jsp?msg=exist");
	}
	if(z==0)
	{
		...
		ps.executeUpdate();
		response.sendRedirect("user_farmer_products.jsp?msg=added");
	}
}
catch(Exception e)
{
	System.out.println(e);
	response.sendRedirect("user_farmer_products.jsp?msg=invalid");
}
%>    
