...
try
{
	...
	PreparedStatement ps=con.prepareStatement("insert into wholesalerchat values(?,?,?)");
	...
	ps.executeUpdate();
	response.sendRedirect("chatwithwholesaler&user.jsp?id="+id+"&id1="+id1+"&msg=send");
			
}
catch(Exception e)
{
	response.sendRedirect("chatwithwholesaler&user.jsp?msg=fail");
