    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-lg-9 col-xl-7">
       ...
       try{
       		...
       		PreparedStatement ps3=con.prepareStatement("select * from wholesalerchat where receiver=? ");
			ps3.setString(1, id1);
       		...
       		catch(Exception e)
       {
			 ...
			 <form action="chatwithwholesaleraction.jsp" method="post">
			 	<div class="input-group mb-3">
					  <input type="hidden" name="id" value="<% out.print(email1); %>">
