...
<!-- ********************************************************************************************************************************** -->
  ...
  <section id="team" class="pb-5">
    <div class="container">
        <h5 class="section-title h1">Applied Farmer</h5>
        <div class="row">
        
        
                        <jsp:scriptlet>
                            String wsid="",wfname1, wlname1, wgender, wemail, wpassword, wcity,wabout,wexp,id,status;
                            try
                            {
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="img/social.png" alt="card image"></p>
