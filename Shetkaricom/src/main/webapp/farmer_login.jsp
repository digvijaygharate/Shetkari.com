      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Farmer Login Here</h3>

            <form class="px-md-2" method="post" action="farmer_login">

              <div class="form-outline mb-4">
                <input type="text" id="form3Example1q" class="form-control" name="flemail" placeholder="Enter Your Email"/>
                <label class="form-label" for="form3Example1q" >Enter Your Email</label>
                
                 <input type="text" id="form3Example1q" class="form-control" name="flpass" placeholder="Enter Your Password"/>
