  ...
  <section id="team" class="pb-5">
    <div class="container">
        ...
        <div class="row">
                        ...
                        <jsp:scriptlet>
                            String wsid="",wfname1, wlname1, wgender, wemail, image="",wpassword, wcity,wabout,wexp,id,status;
                            try
                            {
                                Connection con=DbConnection.getConnect();
                                
                                PreparedStatement ps=con.prepareStatement("select * from applied_ws_farmer where wemail5=?");
                                ps.setString(1, email1);
                                
                                ResultSet rs=ps.executeQuery();
                                while(rs.next())
                                {
                                    wsid=rs.getString("wsid5");
                                	status=rs.getString("status5");
                                    ...
                                    { 
                                        ...
                                        wemail=rs.getString("wemail5");
                                        image=rs2.getString("wimage");
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="img/wholesaler/<%=image %>" alt="card image"></p>
                              ...
                              <jsp:scriptlet>
                                  ...
                                  <ul class="list-inline">
                                        <li class="list-inline-item">
					        			 ...
					        			 <a href="chatwithwholesalerfarmer.jsp?id=<%= rs.getString(3) %>&id1=<%=rs.getString(1) %>" type="button" class="btn btn-light" >Chat With WholeSaler</a>
                                        </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Requested Wholesaler Status : <b><%= rs.getString(4) %></b></p>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form class="px-md-2" method="post" action="user_wholesaler_mess1">
      <div class="modal-body">
