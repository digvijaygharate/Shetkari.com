  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(img/farmer1.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Welcome to <span>Shetkari.com</span></h2>
              <p>Farmer's markets can offer farmers increased profit over selling to wholesalers, food processors, or large grocery firms. 
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right">
            <h2>Why <span style="color:#1bbd36">Shetkari</span>.com</h2> 
            <h3></h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
             <ul>
             <li><i class="ri-check-double-line"></i> 
             Shetakari.com helps to the Indian farmers to make the
		   ...
		   <li> <i class="ri-check-double-line"></i> 
		   Here if suppose some village farmers want to use this facility and
			...
			<li><i class="ri-check-double-line"></i>  
			 On the other side, wholesaler from town can also
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="">Farmer</a></h4>
              <p>A farmer is a person who runs and works on a farm. Farmers work in some aspect of agriculture, growing vegetables, grains, or fruit; or raising animals for milk, eggs, or meat.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <h4><a href="">WholeSaler</a></h4>
              <p>A wholesaler is a company or individual that purchases great quantities of products from manufacturers, farmers, other producers, and vendors. Wholesalers store them in warehouses and sell them on to retailers and businesses.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="">ShopKeeper</a></h4>
              <p>Storekeeping is the process of maintaining safe custody of all raw materials, supplies, finished products, purchased items and other store-related inventories</p>
            </div>
          </div>
