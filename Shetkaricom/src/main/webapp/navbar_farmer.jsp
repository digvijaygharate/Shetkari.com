...
<section id="team" class="pb-5">
    <div class="container">
        <h5 class="section-title h1"><span style="color:#1bbd36">Our</span> <span style="color:black">Farmer</span></h5>
...
if(email!=null){
                        ...
                        <jsp:scriptlet>
                            ...
                            try
                            {
                                ...
                                PreparedStatement ps=con.prepareStatement(("select * from farmer join about_farmer on farmer.femail=about_farmer.femail"));
                             ...
                             //   ResultSet rs1=ps1.executeQuery();
                                ...
                                while(rs.next())
                                {
                                    wid=rs.getString("fid");
                                    wfname1=rs.getString("ffname");
                                    wlname1=rs.getString("flname");
                                    wgender=rs.getString("fgender");
                                    wemail=rs.getString("femail");
                                    wpassword=rs.getString("fpassword");
                                    wcity=rs.getString("fcity");
                                    wabout=rs.getString("fabout");
                                	wexp=rs.getString("fexperience");
                                	image=rs.getString("fimage");
                                	id=rs.getString("id");
                    ...
                    <div class="mainflip flip-0">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <a href="https://www.fiverr.com/share/qb8D02" ><i class="fa fa-plus-square icon-green w3-xlarge" ></i></a>
                                </div>
                            </div>
                        </div>
                         <div class="backside">
                                ...
                                <div class="card-body text-center mt-4">
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="navbar_farmer_desc.jsp?id=<jsp:expression>wemail</jsp:expression>" class="btn btn-light">See Full Details</a>
                                        </li>
...
}else if(wemail1!=null)
{
 ...
 <jsp:scriptlet>
                            String wid,wfname1, wlname1, wgender, wemail, wpassword, wcity,wabout,wexp,id,image1;
                            try
                            {
                                Connection con=DbConnection.getConnect();
                                Connection con1=DbConnection.getConnect();
	        ...
	        <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="image-flip" >
                    <div class="mainflip flip-0">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img src="img/farmer/<%=image1 %>" class="card-img img-fluid" style="width:150px;height:150px" alt="Sorry">
                                            </p>
                                    <h4 class="card-title"><%= wfname1 %> <%= wlname1 %></h4>
                                    <p class="card-text"><%= wabout %></p>
                                    <a href="https://www.fiverr.com/share/qb8D02" ><i class="fa fa-plus-square icon-green w3-xlarge" ></i></a>
                         ...
                         <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <a href="navbar_farmer_desc_wholesaler.jsp?id=<jsp:expression>wemail</jsp:expression>" class="btn btn-light">See Full Details</a>
                                        </li>
                         ...
                         <div class="backside">
                            <div class="card">
                                <div class="card-body  mt-4">
                                    ...
                                    <p class="card-text"><b>City : </b><%= wcity %></p>
                                      <p class="card-text"><b>Business Experience :</b> <%= wexp %></p>
                                    ...
                                    <ul class="list-inline text-center">
                                        <li class="list-inline-item">
                                            <a href="navbar_farmer_desc_user.jsp?id=<jsp:expression>wemail</jsp:expression>" class="btn btn-light">See Full Details</a>
                                        </li>
