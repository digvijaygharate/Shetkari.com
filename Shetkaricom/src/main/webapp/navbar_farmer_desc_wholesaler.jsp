					        ...
					        <a href="login_first.jsp" class="btn btn-light">Login to apply</a>
					             ...
					             <jsp:scriptlet>
                                        ...
                                        try
                                        {
                                            ...
                                            PreparedStatement ps1=con1.prepareStatement("select * from applied_farmer_wholesaler where femail1=? and farmerid1=?");
						      ...
						      <div class="cta-section">
						        <div></div>
						       <br>
						           <form action="Delete_farmer_wholesaler_applied" method="post">
						        ...
						        <div></div>
						           ...
						           <form action="apply_for_farmer_wholesaler" method="post">
                                        <input type="hidden" value="<jsp:expression>wid1</jsp:expression>" name="wid1" />
