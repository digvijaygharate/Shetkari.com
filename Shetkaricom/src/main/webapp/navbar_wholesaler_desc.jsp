					  ...
					  <div class="card dark" style="color:black">
					    ...
					    <div class="card-body">
					      <div class="text-section">
					       ...
					       <jsp:scriptlet>
                                    if (email == null && email2==null && femail2==null)  {
					        ...
					        <a href="login_first.jsp" class="btn btn-light">Login to apply</a>
					             ...
					             <jsp:scriptlet>
                                        ...
                                        try
                                        {
                                            ...
                                            PreparedStatement ps1=con1.prepareStatement("select * from applied_ws where wemail=? and wsid=?");
						      ...
						      <div class="cta-section">
						        <div></div>
						       <br>
						           <form action="Delete_wholesaler_applied" method="post">
						        ...
						        <div></div>
						           ...
						           <form action="apply_for_wholesaler" method="post">
                                        <input type="hidden" value="<jsp:expression>wid1</jsp:expression>" name="wid1" />
