					        ...
					        <a href="login_first.jsp" class="btn btn-light">Login to apply</a>
					             ...
					             <jsp:scriptlet>
                                        ...
                                        try
                                        {
                                            ...
                                            PreparedStatement ps1=con1.prepareStatement("select * from applied_ws_user where wemail=? and wsid=?");
						      ...
						      <div class="cta-section">
						        <div></div>
						       <br>
						           <form action="Delete_wholesaler_user_applied" method="post">
						        ...
						        <div></div>
						           ...
						           <form action="apply_for_wholesaler_user" method="post">
                                        <input type="hidden" value="<jsp:expression>wid1</jsp:expression>" name="wid1" />
