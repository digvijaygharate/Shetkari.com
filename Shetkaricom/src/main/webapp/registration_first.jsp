    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center " data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          ...
          <h2>Please Register Your Self</h2>
        </div>
      </div>
      ...
      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
           ...
           <a href="user_registration.jsp">   <h3>User</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="fa fa-ship icon"></i>
         <a href="farmer_registration.jsp">  <h3>Farmer</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="fa fa-universal-access icon"></i>
            <a href="wholesaler_registration.jsp">  <h3>WholeSaler</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
