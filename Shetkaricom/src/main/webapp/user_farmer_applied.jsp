...
<!-- ********************************************************************************************************************************** -->
  ...
  <section id="team" class="pb-5">
    <div class="container">
         <h5 class="section-title h1"><span style="color:#1bbd36">Check </span> <span style="color:black">Farmer Status</span></h5>
      
        <div class="row">
        
        
                        <jsp:scriptlet>
                            String wsid="",wfname1, wlname1, wgender, wemail, wpassword, wcity,wabout,wexp,id,status,img;
                            try
                            {
                                Connection con=DbConnection.getConnect();
                                
                                PreparedStatement ps=con.prepareStatement("select * from applied_farmer_user where femail=?");
                                ps.setString(1, email1);
                                
                                ResultSet rs=ps.executeQuery();
                                while(rs.next())
                                {
                                    wsid=rs.getString("farmerid");
                                	status=rs.getString("status2");
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="img/farmer/<%= img %>" alt="card image"></p>
                         ...
                         <div class="backside">
                            <div class="card text-center">
                                <div class="card-body  mt-4">
                                    ...
                                    <p class="card-text text-center"><%= wabout %> (Experience : <%= wexp %>)</p>
                                  ...
                                  <ul class="list-inline">
                                        <li class="list-inline-item">
					        			 ...
					        			 <a href="chatwithfarmer.jsp?id=<%= rs.getString(3) %>&id1=<%=rs.getString(1) %>" type="button" class="btn btn-light" >Chat With Farmer</a>
                                        </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <form class="px-md-2" method="post" action="user_farmer_mess">
